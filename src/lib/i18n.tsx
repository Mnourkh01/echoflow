...
const STRINGS = {
  ...
  enhance_offline_notice: {
    en: "No connection, AI step skipped. Showing your raw words.",
    ar: "لا يوجد اتصال، تم تخطّي خطوة الذكاء الاصطناعي. عُرضت كلماتك كما هي.",
  },
  ...
  custom_vocab: { en: "Custom vocabulary", ar: "مفردات مخصصة" },
  custom_vocab_placeholder: {
    en: "EchoFlow, Anthropic, Mnour, Tauri…",
    ar: "إيكوفلو، أنثروبيك، منور، تاوري…",
  },
  custom_vocab_hint: {
    en: "Names, brands, and jargon to recognize. Separate with commas. Helps the model spell tricky words correctly.",
    ar: "أسماء وعلامات ومصطلحات لتمييزها. افصلها بفواصل. يساعد النموذج على كتابة الكلمات الصعبة بشكل صحيح.",
  },
  ...
  sound_style: { en: "Sound", ar: "النغمة" },
  sound_volume: { en: "Volume", ar: "مستوى الصوت" },
  sound_preview: { en: "Preview", ar: "استماع" },
  sound_pack_soft: { en: "Soft", ar: "ناعم" },
  sound_pack_marimba: { en: "Marimba", ar: "ماريمبا" },
  sound_pack_glass: { en: "Glass", ar: "زجاجي" },
  sound_pack_pop: { en: "Pop", ar: "نقرة" },
  sound_pack_chime: { en: "Chime", ar: "جرس" },
  sound_pack_bell: { en: "Bell", ar: "جرس نحاسي" },
  sound_pack_drop: { en: "Drop", ar: "قطرة" },
  sound_pack_synth: { en: "Synth", ar: "سينث" },
  sound_pack_crystal: { en: "Crystal", ar: "كريستال" },
  sound_pack_zen: { en: "Zen", ar: "زِن" },
  sound_pack_click: { en: "Click", ar: "طقّة" },
  sound_pack_warm: { en: "Warm", ar: "دافئ" },
  sound_pack_custom: { en: "Custom", ar: "مخصص" },
  sound_custom_hint: {
    en: "Plays real recorded cues bundled with the app (Kenney, CC0). Swap public/sounds/start.ogg and stop.ogg for your own royalty-free files to change them.",
    ar: "يشغّل نغمات حقيقية مسجّلة مرفقة مع التطبيق (Kenney، CC0). استبدل public/sounds/start.ogg و stop.ogg بملفاتك الخالية من الحقوق لتغييرها.",
  },
  mic_style: { en: "Mic style", ar: "شكل الميكروفون" },
  mic_style_orb: { en: "Classic", ar: "كلاسيكي" },
  mic_style_robot: { en: "Aura", ar: "هالة" },
  mic_style_hint: {
    en: "Aura swaps the record button for a living orb that morphs and glows with your voice. Tap it to react.",
    ar: "الهالة تستبدل زر التسجيل بكرة حية تتموّج وتتوهّج مع صوتك. انقر عليها لتتفاعل.",
  },
  pill_style: { en: "Pill style", ar: "شكل الشريط العائم" },
  pill_style_wave: { en: "Wave", ar: "موجة" },
  pill_style_pulse: { en: "Pulse", ar: "نبض" },
  pill_style_dots: { en: "Dots", ar: "نقاط" },
  pill_style_minimal: { en: "Line", ar: "خط" },
  pill_style_hint: {
    en: "How the floating pill shows your voice while recording.",
    ar: "كيف يعرض الشريط العائم صوتك أثناء التسجيل.",
  },
  accent_color: { en: "Accent color", ar: "لون التمييز" },
  accent_color_hint: {
    en: "Recolors the orb, glow, and highlights.",
    ar: "يغيّر لون الكرة والتوهّج والعناصر المميزة.",
  },
  accent_iris: { en: "Iris", ar: "بنفسجي" },
  accent_teal: { en: "Teal", ar: "فيروزي" },
  accent_amber: { en: "Amber", ar: "كهرماني" },
  accent_rose: { en: "Rose", ar: "وردي" },
  accent_emerald: { en: "Emerald", ar: "زمردي" },
  accent_sky: { en: "Sky", ar: "سماوي" },
  accent_crimson: { en: "Crimson", ar: "قرمزي" },
  accent_gold: { en: "Gold", ar: "ذهبي" },
  accent_fuchsia: { en: "Fuchsia", ar: "أرجواني" },
  accent_lime: { en: "Lime", ar: "ليموني" },
  accent_cobalt: { en: "Cobalt", ar: "كوبالت" },
  accent_violet: { en: "Violet", ar: "بنفسجي داكن" },
  accent_sunset: { en: "Sunset", ar: "غروب" },
  accent_ember: { en: "Ember", ar: "جمر" },
  accent_ocean: { en: "Ocean", ar: "محيط" },
  accent_candy: { en: "Candy", ar: "حلوى" },
  accent_lagoon: { en: "Lagoon", ar: "بحيرة" },
  voice_commands: { en: "Voice commands", ar: "أوامر صوتية" },
  voice_commands_desc: {
    en: "In raw mode, say \"new line\", \"period\", \"comma\", \"question mark\" to insert them.",
    ar: "في الوضع الخام، قل \"سطر جديد\"، \"نقطة\"، \"فاصلة\"، \"علامة استفهام\" لإدراجها.",
  },
